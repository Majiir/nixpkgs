{
  ...
  homie-mqtt = {
    dependencies = ["mqtt-ccutrer" "ruby2_keywords"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  mqtt-homeassistant = {
    dependencies = ["json" "mqtt-ccutrer"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  mqtt-homie-homeassistant = {
    dependencies = ["homie-mqtt" "mqtt-homeassistant"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  waterfurnace_aurora = {
    dependencies = ["ccutrer-serialport" "homie-mqtt" "mqtt-homie-homeassistant" "net-telnet-rfc2217" "puma" "rackup" "rmodbus" "sinatra" "uri"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1r2l73rkrdvc1hfnxn5riqzvn5pf9d06axygkr4wg4lz0ayjvs3m";
      type = "gem";
    };
    version = "1.6.4";
  };
